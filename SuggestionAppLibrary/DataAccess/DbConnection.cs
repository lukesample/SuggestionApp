...
public class DbConnection : IDbConnection
{
	...
	private string _connectionId = "MongoDB"; //references the appsettings.json "MongoDB" entry
	...
	//client gets used outside of this class
	...
	//database has collections (similar to tables)
